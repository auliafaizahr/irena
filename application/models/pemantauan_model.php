...
class Pemantauan_model extends CI_Model {
	...
	public function grafik_rekap_total_kontrak_efektif()
	{
		$sql="SELECT * FROM sbsn_view_rekap_total_nilai_kontrak_efektif";
		return $this->db->query($sql);
	}
	
	public function grafik_rekap_total_penarikan_efektif()
	{
		$sql="SELECT * FROM sbsn_view_rekap_total_penarikan_efektif";
		return $this->db->query($sql);
	}
	
	public function grafik_penarikan_per_triwulan_efektif()
	{
		$sql="SELECT * FROM sbsn_view_rekap_penarikan_per_triwulan_efektif";
		return $this->db->query($sql);
	}
