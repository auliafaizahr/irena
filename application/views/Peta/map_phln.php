		...
		<!-- 	untuk tabel dan grafik per kementerian -->
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Persebaran Sumber Pendanaan Pinjaman Luar Negeri</h5>
				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Persebaran Sumber Pendanaan Pinjaman Luar Negeri berdasarkan Bluebook</h5>
						<div class="ibox-tools">
						<a class="collapse-link">
							<i class="fa fa-chevron-up"></i>
						</a>
				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Persebaran Sumber Pendanaan Pinjaman Luar Negeri berdasarkan Greenbook</h5>
						<div class="ibox-tools">
						<a class="collapse-link">
							<i class="fa fa-chevron-up"></i>
						</a>
				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Persebaran Sumber Pendanaan Pinjaman Luar Negeri berdasarkan Daftar Kegiatan</h5>
						<div class="ibox-tools">
						<a class="collapse-link">
							<i class="fa fa-chevron-up"></i>
						</a>
				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Persebaran Sumber Pendanaan Pinjaman Luar Negeri berdasarkan Loan Agreement</h5>
						<div class="ibox-tools">
						<a class="collapse-link">
							<i class="fa fa-chevron-up"></i>
						</a>
