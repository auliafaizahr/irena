 <table class="table table-hover table-stripped toggle-arrow-tiny border" id="example_lampiran" style="width:100%"> 
	...
	<tbody>
		<?php $no=0; foreach($dok->result() as $row): $no++?>
		<tr class="gradeX">
			<td><?php echo $row->kat; ?></td>
			<td><?php echo $row->nama; ?></td>
			<td><?php echo $row->ket; ?></td>
			<td><a href="<?php echo base_url(); ?>uploads/hibah/<?php echo $row->berkas; ?>" target="_blank" class="btn btn-xs btn-info" type="button"><i class="fa fa-download"></i></a></td>
				...
				?>
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li>
										<a href="#" onclick="tampilkan_form_edit('hibah/tampilkan_dok_usulan_edit/<?php echo $row->id; ?>')">Edit</a>
									</li>
									<li>
										<a href="#" onclick="tampilkan_form_hapus('hibah/tampilkan_dok_usulan_hapus/<?php echo $row->id; ?>')"><span class="text-danger" ><strong>Hapus</strong></span></a>
									</li>
								</ul>
							</div>
				<?php }else{ 
