<div class="modal inmodal fade" id="modalLayak" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false">
...
<script>
    $(document).ready(function(){
		...
		$('#htmlForm').submit(function(e) {
            ...
            $.ajax({
            	 type: 'POST',
                url: '<?php echo base_url(); ?>Usulan/usulan_simpan_layak',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
