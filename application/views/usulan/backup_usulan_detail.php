...
<div class="ibox-content">
        <div class="ibox float-e-margins">
          ...
          <table class="table table-hover table-mail">
            <tbody>
              <tr class="read">
                <td class="mail-ontact text-right">Status</td>
                <td class="mail-subject"> 
                <?php if($detail->is_BB == "1"){

                  echo "Sudah tercantum dalam  ";
                  $bb_detail = $this->Usulan_model->ambil_bb_detail($detail->id);
                    ...
                    echo "Belum tercantum dalam Bluebook";
                    } ?></td>
              </tr>
               <tr class="read">
        ...
        <div class="ibox float-e-margins">
          ...
          <table class="table table-hover table-mail">
            ...
            <tbody>
              <tr class="read">
                <td class="mail-ontact text-right">Judul Proyek</td>
                <td class="mail-subject">  <?php  echo $isi->judul_proyek_eng; ?></td>
              </tr>
              <tr class="read">
                <td class="mail-ontact text-right">Program</td>
                <td class="mail-subject"> <?php echo $this->Usulan_model->ambil_program_proyek($isi->id_program)->nama_program; ?></td>
              </tr>
              <tr class="read">
                <td class="mail-ontact text-right">Instansi Pengusul</td>
                <td class="mail-subject"> <?php echo $this->Usulan_model->ambil_instansi_untuk_usulan($value->id_instansi)->nama_instansi; ?></td>
