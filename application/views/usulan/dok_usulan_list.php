 <table class="table table-hover table-stripped toggle-arrow-tiny border" id="example_lampiran2" style="width:100%"> 
	<thead>
		<tr>
			<th>Kategori</th>
			<th>Nama</th>
	...
	<tbody>
		...
		<tr class="gradeX">
			...
			<td><a href="<?php echo base_url(); ?>uploads/PLN/<?php echo $row->berkas; ?>" target="_blank" class="btn btn-xs btn-info" type="button"><i class="fa fa-download"></i></a></td>
