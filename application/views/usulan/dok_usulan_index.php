...
<script>
	$(document).ready(function(){
		...
		$('#btnTambah').click(function(){
			$.ajax({
				url: "<?php echo base_url(); ?>hibah/tampilkan_dok_usulan_tambah/<?php echo $this->uri->segment(3); ?>",
	...
	function segarkan_syarat(){
		$.get("<?php echo base_url(); ?>hibah/tampilkan_dok_usulan_list/<?php echo $this->uri->segment(3); ?>", function(data) {
			$("#tabel").html(data);
		});
	}
</script>
