            ...
            <tbody>
              ...
              <tr class="read">
                ...
                <td class="mail-subject">
                    ...
                    if($this->Greenbook_model->ambil_layak($detail->id)->is_layak == '1'){

                      if($this->Greenbook_model->ambil_layak($detail->id)->is_kasubdit_layak == "0") {
                      ...
                      }elseif ($this->Greenbook_model->ambil_layak($detail->id)->is_kasubdit_layak == "1") {
                    ...
                    }elseif($this->Greenbook_model->ambil_layak($detail->id)->is_layak == '2'){
                    ...
                    if ($this->Greenbook_model->ambil_layak($detail->id)->is_layak != '0') {
                       $user = $this->Greenbook_model->ambil_layak($detail->id)->update_by;
                      $nama = $this->Usulan_model->ambil_user($user)->nama_depan;
                      echo "<p> Penilaian dilakukan oleh ";
                      echo "<b>".$nama."</b> </br>";
                      echo "<p> Penilaian dilakukan pada " .$this->Greenbook_model->ambil_layak($detail->id)->update_at. "</p>";
                      echo "<p> Catatan Penilaian : </br> </p> ";
                      echo "<b>".$this->Greenbook_model->ambil_layak($detail->id)->catatan_staff_layak."</b> </br>";
                    }

                    if ($this->Greenbook_model->ambil_layak($detail->id)->is_kasubdit_layak != '0') {
                      $user2 = $this->Greenbook_model->ambil_layak($detail->id)->kasubdit_layak_by;
                      $nama2 = $this->Usulan_model->ambil_user($user2)->nama_depan;
                      echo "<p> Disetujui atau dinilai ulang oleh " ."<b>".$nama2. "</b>"."</p>";
                      echo "<p> Penilaian dilakukan pada " .$this->Greenbook_model->ambil_layak($detail->id)->kasubdit_layak_at. "</p>";
                      echo "<p> Catatan Penilaian Kasubdit : </br> </p> ";
                      echo "<b>".$this->Greenbook_model->ambil_layak($detail->id)->layak_catatan_kasubdit."</b> </br>";
                    }
                    /*$query  = $this->arsip_model->ambil_nama_user_by_id($usulan->nilai_admin_id);
                    $user = $query->row();
                    //echo $user->nama_panggilan;
               ...
               <tr class="read">
                <td class="mail-ontact text-right">Diusulkan ke DK</td>
                <td class="mail-subject">
               
                
                    <?php 

                    if($this->Greenbook_model->ambil_layak($detail->id)->is_dk == '1'){

                      if($this->Greenbook_model->ambil_layak($detail->id)->is_dk_kasubdit == "0") {
                         echo "<p><span class='label label-warning'>Administrasi tidak lengkap, dalam proses menunggu persetujuan penilaian kasubdit</span></p>";
                        //echo "<p><span class='label label-danger'>Belum memenuhi kelengkapan</span></p>";
                      }elseif ($this->Greenbook_model->ambil_layak($detail->id)->is_dk_kasubdit == "1") {
                        echo "<p><span class='label label-warning'>Sudah dilakukan penilaian, namun kasubdit meminta untuk dinilai kembali</span></p>";
                      }else{
                        echo "<p><span class='label label-danger'>Hasil penilaian administrasi tidak lengkap</span></p>";
                      }
                    ...
                    }elseif($this->Greenbook_model->ambil_layak($detail->id)->is_dk == '2'){
                    ...
                    if ($this->Greenbook_model->ambil_layak($detail->id)->is_dk != '0') {
                      $user4 = $this->Greenbook_model->ambil_layak($detail->id)->is_dk_update_by;
                      $nama4 = $this->Usulan_model->ambil_user($user)->nama_depan;
                      echo "<p> Penilaian dilakukan oleh ";
                      echo "<b>".$nama4."</b> </br>";
                      echo "<p> Penilaian dilakukan pada " .$this->Greenbook_model->ambil_layak($detail->id)->is_dk_update_at. "</p>";
                      echo "<p> Catatan Penilaian : </br> </p> ";
                      echo "<b>".$this->Greenbook_model->ambil_layak($detail->id)->catatan_staff_layak."</b> </br>";
                    ...
                    if ($this->Greenbook_model->ambil_layak($detail->id)->is_dk_kasubdit != '0') {
                       $user8 = $this->Greenbook_model->ambil_layak($detail->id)->kasubdit_dk_by;
                      $nama8 = $this->Usulan_model->ambil_user($user8)->nama_depan;
                      echo "<p> Penilaian dilakukan oleh ";
                      echo "<b>".$nama8."</b> </br>";
                      echo "<p> Penilaian dilakukan pada " .$this->Greenbook_model->ambil_layak($detail->id)->kasubdit_dk_at. "</p>";
                      echo "<p> Catatan Penilaian : </br> </p> ";
                      echo "<b>".$this->Greenbook_model->ambil_layak($detail->id)->dk_catatan_kasubdit."</b> </br>";
                    }
                    /*$query  = $this->arsip_model->ambil_nama_user_by_id($usulan->nilai_admin_id);
                    $user = $query->row();
                    //echo $user->nama_panggilan;
              ...
              <?php if($this->Greenbook_model->ambil_layak($detail->id)->is_dk_kasubdit == '2' &&  $this->Greenbook_model->ambil_layak($detail->id)->is_dk == '2'){ ?>
              <tr class="read">
