<div class="modal inmodal fade" id="modalDK" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
    <div class="modal-content">  
				<div class="ibox-title">
					<h5>Tambahkan Proyek ke Daftar Kegiatan </h5>
				</div>
							...
							<div class="col-sm-8">
								<div class="checkbox">
									<label>
										...
										<input type="hidden" name="id_bb_proyek" id="id_bb_proyek" class="form-control" value="<?php echo $detail->id_bb_proyek; ?>">
...
<script>
    $(document).ready(function(){
		...
		$('#htmlForm').submit(function(e) {
			...
			var id_bb_proyek		 		= $("#id_bb_proyek").val();
			...
			form_data.append('id_bb_proyek', id_bb_proyek);
            ...
            $.ajax({
            	 type: 'POST',
                url: '<?php echo base_url(); ?>Greenbook/tambah_ke_DK',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
