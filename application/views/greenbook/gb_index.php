<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2>Daftar Proyek Greenbook</h2>
		<ol class="breadcrumb">
			<li>
				Halaman ini memberikan informasi terkait proyek yang sudah masuk Greenbook
			</li>
		</ol>
	</div>
</div>
...
<script>
	...
	function segarkan_data(){
		$.get("<?php echo base_url(); ?>Greenbook/tampilkan_gb_list", function(data) {
			$("#div_index").html(data);
		});
	}
