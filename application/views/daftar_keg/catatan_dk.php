...
<script>
	...
	function segar() {
		$.get("<?php echo base_url(); ?>daftar_kegiatan/catatan", function(data) {
			$(".isi").html(data);
		});
	}
		...
		$('#htmlForm').submit(function(e) {
			...
			form_data.append('id_dk_proyek', id);
            ...
            $.ajax({
            	 type: 'POST',
                url: '<?php echo base_url(); ?>daftar_kegiatan/tambah_catatan',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
