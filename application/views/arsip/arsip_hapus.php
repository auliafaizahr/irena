  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        	Apakah Anda yakin untuk menhapus arsip dengan no <?php echo $arsip->no; ?> tanggal <?php echo $arsip->tgl; ?> ?
      </div>
	  <form class="form-horizontal" id="htmlForm" action="" method="post" enctype="multipart/form-data"> 
				<input type="hidden" name="id" class="form-control" value="<?php echo $arsip->id; ?>">
		</form>
...
<script>
    $(document).ready(function(){
		...
		{
			$.ajax({
				url: "<?php echo base_url(); ?>arsip/hapus_yakin",
				type: "POST",
