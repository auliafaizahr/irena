<div class="modal inmodal fade" id="modal_arsip_bb" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#tmbh_arsip', function(){  
          ...
          /* $('#myModalDetail').modal('show');
           ...
           $.ajax({
              type : 'post',
                url : "<?php echo base_url(); ?>Bluebook/tambah_arsip_surat",
                data :  'id='+ id,
