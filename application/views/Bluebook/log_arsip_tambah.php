<div class="modal inmodal fade" id="modalTambah" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false" style="overflow:hidden;">
            ...
            <div class="ibox">
                ...
                <form class="form-horizontal" id="htmlForm" action="" method="post" enctype="multipart/form-data">
                    <div class="ibox-content">
                        ...
                        <input type="hidden" name="id_proyek" id="id_proyek" class="form-control" value="">
...
$.fn.select2.defaults.set( "theme", "bootstrap" );
    $(document).ready(function(){
        ...
        $('#htmlForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>Usulan/log_usulan_tambah_simpan',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
