	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				Apakah Anda yakin untuk menghapus data <span class="text-danger"><strong><?php echo $dpp->nama; ?></strong></span> ?
			</div>
			<form class="form-horizontal" id="htmlForm" action="" method="post" enctype="multipart/form-data"> 
				<input type="hidden" name="id" class="form-control" value="<?php echo $dpp->id; ?>">
			</form>
...
<script>
    $(document).ready(function(){
		...
		{
			$.ajax({
				url: "<?php echo base_url(); ?>data/dpp_hapus_data",
				type: "POST",
