		...
		<div class="modal-content">
			<div class="ibox">
				<div class="ibox-title">
					<h5>Tambah Kategori Proyek SBSN</h5>
				</div>
				<form class="form-horizontal" id="htmlForm" action="" method="post" enctype="multipart/form-data">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Kategori" >
							</div>
						</div>
...
<script>
    $(document).ready(function(){
		...
		$('#htmlForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>data/kat_sbsn_simpan/tambah',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
