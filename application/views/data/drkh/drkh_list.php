			...
			<td>
				<div class="input-group-btn">
					...
					<ul class="dropdown-menu pull-right">
						<li><a href="#" onclick="tampilkan_form_edit('data/drkh_edit/<?php echo $row->id; ?>')">Edit</a></li>
						<li><a href="#" onclick="tampilkan_form_hapus('data/drkh_hapus/<?php echo $row->id; ?>')"><span class="text-danger" ><strong>Hapus</strong></span></a></li>
					</ul>
				</div>
			</td>
		</tr>
