				...
				<form class="form-horizontal" id="htmlForm" action="" method="post" enctype="multipart/form-data">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Instansi" value="<?php echo $instansi->nama; ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="singkatan" id="singkatan" class="form-control" placeholder="Singkatan Instansi" value="<?php echo $instansi->singkatan; ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="aktif" id="aktif" class="form-control" >
									<option value="<?php echo $instansi->aktif; ?>">
										<?php 
											if($instansi->aktif == 1){
												echo "Aktif"; 
											}else{
						...
						<input type="hidden" name="id" id="id" class="form-control" value="<?php echo $instansi->id; ?>">
...
<script>
    $(document).ready(function(){
		...
		$('#htmlForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>data/instansi_simpan/edit',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
