				...
				<form class="form-horizontal" id="htmlForm" action="" method="post" enctype="multipart/form-data">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="nama_panggilan" id="nama_panggilan" class="form-control" placeholder="Nama Panggilan" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group date" >
									<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name= "tgl_lahir" id="tgl_lahir" class="form-control"  data-date-format='yyyy-mm-dd'>
								</div>
							</div>
						</div>
...
<script>
    $(document).ready(function(){
		...
		$('#htmlForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>data/user_simpan/tambah',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
