<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			<li>
				Halaman ini memberikan informasi terkait data pengguna sistem informasi.
			</li>
		</ol>
	</div>
</div>
...
<script>
	...
	function segarkan_data(){
		$.get("<?php echo base_url(); ?>data/user_list", function(data) {
			$("#div_index").html(data);
		});
	}
	...
	$(document).ready(function(){
		...
		$('#btnTambah').click(function(){
			$.ajax({
				url: "<?php echo base_url(); ?>data/user_tambah",
				beforeSend: function(){
					//notif();
					showLoading();
				},
