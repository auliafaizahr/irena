<div class="modal inmodal fade" id="modalTambahDokumen" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false" style="overflow:hidden;">
			...
			<div class="ibox">
				...
				<form class="form-horizontal" id="htmlForm"  method="post" enctype="multipart/form-data">
					<div class="ibox-content">
						...
						<input type="hidden" name="id_proyek" id="id_proyek" class="form-control" value="<?php echo $detail->id; ?>">
						<input type="hidden" name="update_by" class="form-control" value="<?php echo "saya"; ?>">
...
<script>
    $(document).ready(function(){
		$('#htmlForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>Usulan/tambah_baru/tambah',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
