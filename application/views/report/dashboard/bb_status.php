					<div id="container_9" style="min-width: 400px; max-width: 800px; height: 300px; margin: 0 auto"></div>
...
$table.find('.js-view-parents').on('click', function(e) {
 ...
 // var parentsData = [];
	...
	$.ajax({
				url: "<?php echo base_url(); ?>usulan/filter_statusumum_isi_bluebook/"+id,
				type: "GET",
				dataType: "html",
				...
				success:function(data,){
					...
					$.getJSON("<?php echo base_url(); ?>usulan/filter_statusumum_isi_bluebook/"+id, function(json) {
					console.log(json);
