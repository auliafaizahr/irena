  ...
  <table class="table table-striped table-hover js-table" id="example2">
    <thead>
      <tr>
        <th style="width:600px;">Lender</th>
...
$table.find('.js-view-parents').on('click', function(e) {
 ...
 // var parentsData = [];
	...
	$.ajax({
				url: "<?php echo base_url(); ?>greenbook/filter_lender_isi_gb/"+id,
				type: "GET",
				dataType: "html",
				...
				success:function(data,){
					...
					$.getJSON("<?php echo base_url(); ?>greenbook/filter_lender_isi_gb/"+id, function(json) {
					console.log(json);
