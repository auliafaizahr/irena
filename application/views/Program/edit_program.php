                 ...
                 <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label for="nama_program" class="col-sm-3 control-label">Judul Program (id)</label>
                             <div class="col-sm-9">
                             <input type="text" name="nama_program" id="nama_program" class="form-control" placeholder="Nama Programs" value="<?php echo $detail->nama_program; ?>">
                             </div>
                         ...
                         <div class="form-group">
                            <label for="judul_eng" class="col-sm-3 control-label">Judul Program (eng)</label>
                             <div class="col-sm-9">
                             <input type="text" name="judul_eng" id="judul_eng" class="form-control" placeholder="Judul Program (eng)" value="<?php echo $detail->judul_eng; ?>">
                             </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                             <textarea name="latar_belakang_eng" id="latar_belakang_eng" class="col-sm-12" rows="10" placeholder="Latar Belakang dalam Bahasa Inggris"><?php echo $detail->latar_belakang_eng; ?></textarea>
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9">
                             <textarea name="ruang_lingkup_eng" id="ruang_lingkup_eng" class="col-sm-12" rows="10" placeholder="Ruang Lingkup dalam Bahasa Inggris"><?php echo $detail->ruang_lingkup_eng; ?></textarea>
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9">
                             <textarea name="outcome" id="outcome" class="col-sm-12" rows="5" placeholder="Ruang Lingkup dalam Bahasa Inggris"><?php echo $detail->outcome; ?></textarea>
                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#htmlForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>program/usulan_simpan/edit',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
