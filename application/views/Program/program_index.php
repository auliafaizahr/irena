<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			<li>
				Halaman ini memberikan informasi terkait Program pada Pinjaman Luar Negeri
			</li>
		</ol>
	</div>
</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				<button type="button" class="btn btn-success btn-sm pull-right" id="tmbhProgram"><i class="glyphicon glyphicon-plus-sign" ></i> Tambahkan Program</a></button>
					<div  id="div_index">
					</div>
				</div>
			</div>
...
<script>
	...
	function refresh_data(){
		$.get("<?php echo base_url(); ?>program/tampilkan_program_list", function(data) {
			$("#div_index").html(data);
		});
	}
	...
	$(document).on('click', '#tmbhProgram', function(){  
