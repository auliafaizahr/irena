				...
				<form class="form-horizontal" id="htmlForm" action="<?php echo base_url(); ?>arsip/disposisi_simpan/<?php  echo $this->uri->segment(3); ?>" method="post" enctype="multipart/form-data">
					<div class="ibox-content">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="kat" id="kat" class="form-control" placeholder="Kategori Dok. Pendukung" value="<?php echo $syarat_usulan->kat; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="nama" class="col-sm-2 control-label">Nama</label>
							<div class="col-sm-10">
								<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" value="<?php echo $syarat_usulan->nama; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="ket" class="col-sm-2 control-label">Keterangan</label>
							<div class="col-sm-10">
								<textarea name="ket" id="ket" class="col-sm-12" rows="5" placeholder="Keterangan"><?php echo $syarat_usulan->ket; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<a href="<?php echo base_url(); ?>uploads/proyek/dok_syarat/<?php echo $syarat_usulan->berkas; ?>" target="_blank" class="btn btn-info btn-xs" type="button"><i class="fa fa-download"></i> Lihat</a>
							</div>
						</div>
						<input type="hidden" name="id" id="id" class="form-control" value="<?php  echo $syarat_usulan->id; ?>">
						<input type="hidden" name="berkas_lama" id="berkas_lama" class="form-control" value="<?php echo $syarat_usulan->berkas; ?>">
						<input type="hidden" name="id_proyek" id="id_proyek" class="form-control" value="<?php  echo $syarat_usulan->id_proyek; ?>">
...
<script>
    $(document).ready(function(){
		$('#htmlForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>sbsn/syarat_usulan_simpan/edit',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
