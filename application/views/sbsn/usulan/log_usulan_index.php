...
<script>
	$(document).ready(function(){
		...
		$('#btnTambah').click(function(){
			$.ajax({
				url: "<?php echo base_url(); ?>sbsn/tampilkan_form_log_usulan_tambah/<?php echo $this->uri->segment(3); ?>",
	...
	function segarkan_log(){
		$.get("<?php echo base_url(); ?>sbsn/tampilkan_data_log_usulan/<?php echo $this->uri->segment(3); ?>", function(data) {
			$("#tabel").html(data);
		});
	}
</script>
