<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2>Daftar Prioritas Proyek (DPP) SBSN PBS</h2>
		<ol class="breadcrumb">
			<li>
				Halaman ini memberikan informasi terkait usulan awal proyek yang akan dibiayai melalui penerbitan SBSN PBS.
			</li>
		</ol>
	</div>
</div>
...
<script>
	...
	function segarkan_data(){
		$.get("<?php echo base_url(); ?>sbsn/tampilkan_dpp_list", function(data) {
			$("#div_index").html(data);
		});
	}
