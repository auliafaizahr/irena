 <table class="table table-hover table-stripped toggle-arrow-tiny border" id="example_lampiran" style="width:100%"> 
	...
	<tbody>
		...
		<tr class="gradeX">
			<td><?php echo $row->nama_proyek_dok_kategori; ?></td>
			<td><a href="#" onclick="tampilkan_form_detail('sbsn/tampilkan_form_log_usulan_detail/<?php echo $row->id; ?>')"><?php echo $row->nama; ?></a></td>
			...
			<td>
				<div class="input-group-btn">
					...
					<ul class="dropdown-menu pull-right">
						<li>
							<a href="#" onclick="tampilkan_form_edit('sbsn/tampilkan_form_log_usulan_edit/<?php echo $row->id; ?>')">Edit</a>
						</li>
						<li>
							<a href="#" onclick="tampilkan_form_hapus('sbsn/tampilkan_form_log_usulan_hapus/<?php echo $row->id; ?>')"><span class="text-danger" ><strong>Hapus</strong></span></a>
						</li>
					</ul>
				</div>
			</td>
