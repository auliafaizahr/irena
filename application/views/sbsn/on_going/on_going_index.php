<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2>Pemantauan SBSN</h2>
		<ol class="breadcrumb">
			<li>
				Halaman ini memberikan informasi terkait pemantauan SBSN PBS.
			</li>
		</ol>
	</div>
</div>
...
<script>
	...
	*/
	...
	function segarkan_data(){
		$.get("<?php echo base_url(); ?>sbsn/tampilkan_on_going_list", function(data) {
			$("#div_index").html(data);
		});
	}
	...
	$(document).ready(function(){
		...
		$('#btnTambah').click(function(){
			$.ajax({
				url: "<?php echo base_url(); ?>sbsn/tampilkan_on_going_tambah",
				beforeSend: function(){
					//notif();
					showLoading();
				},
