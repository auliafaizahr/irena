<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2>Daftar Usulan Proyek Pinjaman Luar Negeri</h2>
		<ol class="breadcrumb">
			<li>
				Halaman ini memberikan informasi terkait proyek yang diusulkan untuk mendapatkan pendanaan dari Pinjaman Luar Negeri
			</li>
		</ol>
	</div>
</div>
...
<script>
	...
	function refresh_data(){
		$.get("<?php echo base_url(); ?>Usulan/tampilkan_usulan_list", function(data) {
			$("#div_index").html(data);
		});
	}
