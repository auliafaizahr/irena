						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="id_log_kategori" id="id_log_kategori" class="form-control">
									<?php
										$query				= $this->hibah_model->ambil_log_kategori_by_id($log_usulan->id_log_kategori);
										$log_kategori			= $query->row();
										
									?>
									<option value="<?php echo $log_kategori->id; ?>"><?php echo $log_kategori->nama; ?></option>
