...
<div class="wrapper wrapper-content animated fadeIn">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content css-animation-box">
					<div class="alert alert-success">
						Sortir data berdasarkan instansi ssss: 
						<div class="btn-group">
							...
							<ul class="dropdown-menu pull-right" role="menu">
								<li>
									<a href="#" onclick="load_lender4()">Kementerian Agama</a>
								</li>
								<li>
									<a href="#" onclick="load_lender3()">Kementerian Pekerjaan Umum dan Perumahan Rakyat</a>
								</li>
								<li>
									<a href="#" onclick="load('dashboard/sortir/peta/1')">Kementerian Perhubungan</a>
								</li>
							</ul>
							
							<script>
								function load_lender1(){
									$("#sortirpeta").load("dashboard/sortir/peta/1");
								}
								function load_lender3(){
									$("#sortirpeta").load("penarikan/pinjamanlender/3/2");
								}
								function load_lender4(){
									$("#sortirpeta").load("<?php echo base_url(); ?>dashboard/sortir/1");
								}
							</script>
						</div>
					</div>
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Grafik Perkembangan Pemanfaatan SBSN</h5> <?php //var_dump( $this->db->last_query()); ?>
					<div class="ibox-tools">
						<a class="collapse-link">
							<i class="fa fa-chevron-up"></i>
						</a>
