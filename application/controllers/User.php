...
class User extends CI_Controller {
	...
	{  
		$config = Array(  
						'protocol' => 'smtp',  
						'smtp_host' => 'ssl://mail.muds.my.id',  
						'smtp_port' => 465,  
						'smtp_user' => 'irena@muds.my.id',   
						'smtp_pass' => 'P3ndanaan',   
						'mailtype' => 'html',   
						'charset' => 'iso-8859-1'  
					   );  
		...
		$this->email->from('irena@muds.my.id', 'Admin IRENA');   
		$list = array('firman.aprianto@support.bappenas.go.id', 'f.manangin@gmail.com');
		$pengguna = array('Bapak Anto', 'Bapak Firman');
		foreach($pengguna as $value){
						$yth = $value . ", ";
		}
		$this->email->to($list);   
		$this->email->subject('Disposisi');   
		$this->email->message('
			<html>
				 <head>
				...
				<body>
					<p>Kepada Yth.: <strong>'.rtrim(implode(', ', $pengguna), ', ').'</p></strong>
					<br />
					<br />
					<p>Dengan hormat,</p>
					<br />
					<p>Bersama ini kami sampaikan bahwa Bapak/Ibu mendapat disposisi dari Ibu Direktur atas surat No. .... </p>
					<br / >
					<p>Demikian, disampaikan. Atas perhatian dan kerjasama Bapak/Ibu, kami ucapkan terima kasih.</p>
					<br />
					<br />
					<p>Hormat kami,</p>
					<br />
